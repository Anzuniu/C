...
char *ft_strtrim(char const *s1, char const *set)
{
    ...
    size_t i;
    size_t j; 
    cpy_s1 = (char *)s1; //Hacemos una copia editable de s1 ya que es const
    cpy_set = (char *)set;//Hacemos una copia editable de set ya que es const
    if (!cpy_s1 || !cpy_set) //Chequeamos que no nos de fallos
        return NULL;
