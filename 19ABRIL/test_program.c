...
int main() {
    ...
    char c2 = 'm';
    char c3 = 'h';
    char *str = "Cómo estan los máquinas";
    char *s1 = "Cómo estan";
    char *s2 = "los máquinas";
    char *s3 = "    trim me     ";
    char set[] = " ";
    char *s4 = "Cómo estan los máquinas";
    ...
    // ft_strncmp TEST
    char 	*s1_cmp = "Cómo estan los máquinas";
    char 	*s2_cmp = "Cómo estan los Máquinas";
    size_t	size_cmp = 20;
    ...
    s1_cmp = "Cómo estan los máquinas";
    char	*s3_cmp = "Cómo estan los máquinas";
    size_cmp = 20;
    ...
    char *haystack_strnstr = "Cómo estan los máquinas";
    char *needle_strnstr = "máquinas";
    ...
    const char *s1_strdup = "Cómo estan los máquinas";
...
printf("\n------------------------------------------------------------------------------------\n			PARTE 2  FUNCIONES ADICIONALES				\n------------------------------------------------------------------------------------\n\n");
    ...
    char *s1_strjoin = "Cómo estan ";
    char *s2_strjoin = "los máquinas";
    printf("	Primera cadena : %s\n	Segunda cadena : %s\n	Cadena resultante : %s\n\n", s1_strjoin, s2_strjoin, ft_strjoin(s1_strjoin, s2_strjoin));

    // ft_strtrim TEST
    const char *s1_strtrim = "   Cómo estan los máquinas   ";
    ...
    printf("Test ft_split(\"Cómo estan los máquinas\", ' '):\n");
    ...
    // ft_strmapi TEST
    const char *str_strmapi = "Cómo estan los máquinas";
    ...
    char	s_striteri[] = "Cómo estan los máquinas";
    printf ("	Cadena original: %s\n", s_striteri);
    printf("	Función a aplicar: ft_toupper\n");
    ...
    char       *str_putstr = "Cómo estan los máquinas";
    int         fd2 = 1;
    ...
    char *str_putendl = "Cómo estan los máquinas";
    int fd3 = 1;
    printf("	Cadena a imprimir : %s\n	Salida : %d\n", str_putendl, fd3);
